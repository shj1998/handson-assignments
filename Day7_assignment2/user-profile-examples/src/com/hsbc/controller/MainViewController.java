...
//				user.setName(name);
			...
			case 3:
				...
				break;
			case 4:
				System.out.println("Enter user id and the phone number to update :");
				int userId = scanner.nextInt();
				long phone = scanner.nextLong();
				try {
					User updatePhone = service.updatePhoneNo(userId, phone);
				...
				break;
			case 5:
				System.out.println("Enter user id and the password to update :");
				int userID = scanner.nextInt();
				scanner.nextLine();
				String password = scanner.nextLine();
				try {
					User updatePassword = service.updatePassword(userID, password);
