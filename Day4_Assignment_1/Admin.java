public class Admin extends Register {
    ...
    public Admin (String name,String dob,String gender,long phone,Address add,int id,double salary){
    ...
    public void displayInformation(){
        System.out.println("Name = " + name + " Salary = " + salary + " Dob = " + dob + " gender = " +  gender + " phone = 0" + phone + " Id = " + id);
